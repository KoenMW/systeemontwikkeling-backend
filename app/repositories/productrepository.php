...
class ProductRepository extends Repository
{
    ...
    {
        try {
            if (empty($product->name)) throw new PDOException("Name is required");
            if (empty($product->price)) throw new PDOException("Price is required");
            if (empty($product->description)) throw new PDOException("Description is required");
            if (empty($product->image)) throw new PDOException("Image is required");
            if (empty($product->category_id)) throw new PDOException("Category is required");
